...
#line 93 "frontend/compiler.tab.cpp"
...
{
       0,    87,    87,    91,    97,   103,   107,   111,   115,   122,
     127,   133,   137,   141,   145,   149,   153,   157,   161,   165,
     172,   180,   188,   197,   207,   215,   223,   233,   243,   250,
     258,   262,   266,   270,   274,   278,   282,   286,   290,   293,
     297,   301,   305,   310,   315,   320,   328
};
#endif
...
#line 87 "frontend/parser.y"
                                                                                            { 
                                                                                                ;
                                                                                            }
#line 1216 "frontend/compiler.tab.cpp"
    break;

  case 3: /* procedures: procedures PROCEDURE proc_head IS declarations IN commands END  */
#line 91 "frontend/parser.y"
                                                                                        { 
...
#line 1260 "frontend/compiler.tab.cpp"
    break;
...
#line 1290 "frontend/compiler.tab.cpp"
    break;
...
#line 1298 "frontend/compiler.tab.cpp"
    break;
...
#line 1322 "frontend/compiler.tab.cpp"
    break;
...
#line 1330 "frontend/compiler.tab.cpp"
    break;
...
#line 1338 "frontend/compiler.tab.cpp"
    break;
...
#line 1346 "frontend/compiler.tab.cpp"
    break;
...
#line 1354 "frontend/compiler.tab.cpp"
    break;

  case 19: /* proc_call: PIDENTIFIER '(' args ')'  */
#line 165 "frontend/parser.y"
                                                                                         { 
                                                                                            Token token_id({ .line_number = yylineno, .string_value = (yyvsp[-3].id)}); 
                                                                                            Pidentifier p(token_id);
...
#line 1365 "frontend/compiler.tab.cpp"
    break;

  case 20: /* declarations: declarations ',' PIDENTIFIER  */
#line 172 "frontend/parser.y"
                                                                                         { 
...
#line 1377 "frontend/compiler.tab.cpp"
    break;

  case 21: /* declarations: declarations ',' PIDENTIFIER '[' NUMBER ']'  */
#line 180 "frontend/parser.y"
                                                                                         { 
                                                                                            Token token_id({ .line_number = yylineno, .string_value = (yyvsp[-3].id)}); 
                                                                                            Pidentifier p(token_id);
...
#line 1389 "frontend/compiler.tab.cpp"
    break;
...
#line 1402 "frontend/compiler.tab.cpp"
    break;

  case 23: /* declarations: PIDENTIFIER '[' NUMBER ']'  */
#line 197 "frontend/parser.y"
                                                                                         { 
...
#line 1416 "frontend/compiler.tab.cpp"
    break;
...
#line 1428 "frontend/compiler.tab.cpp"
    break;
...
#line 1440 "frontend/compiler.tab.cpp"
    break;
...
#line 1453 "frontend/compiler.tab.cpp"
    break;

  case 27: /* args_decl: T PIDENTIFIER  */
#line 234 "frontend/parser.y"
                                                                                         { 
                                                                                            Token token_id({ .line_number = yylineno, .string_value = (yyvsp[0].id)}); 
                                                                                            Pidentifier p(token_id);
                                                                                            ArgDeclaration arg_dec(p, true);
...
#line 1466 "frontend/compiler.tab.cpp"
    break;

  case 28: /* args: args ',' PIDENTIFIER  */
#line 243 "frontend/parser.y"
                                                                                         {
                                                                                            Token token_id({ .line_number = yylineno, .string_value = (yyvsp[0].id)}); 
                                                                                            Pidentifier p(token_id); 
...
#line 1477 "frontend/compiler.tab.cpp"
    break;

  case 29: /* args: PIDENTIFIER  */
#line 250 "frontend/parser.y"
                                                                                         { 
                                                                                            Token token_id({ .line_number = yylineno, .string_value = (yyvsp[0].id)}); 
                                                                                            Pidentifier p(token_id); 
...
#line 1489 "frontend/compiler.tab.cpp"
    break;

  case 30: /* expression: value  */
#line 258 "frontend/parser.y"
                                                                                         {  
                                                                                             (yyval.expression) = new UnaryExpression((yyvsp[0].value));   
                                                                                         }
#line 1497 "frontend/compiler.tab.cpp"
    break;
...
#line 1505 "frontend/compiler.tab.cpp"
    break;
...
#line 1513 "frontend/compiler.tab.cpp"
    break;
...
#line 1521 "frontend/compiler.tab.cpp"
    break;
...
#line 1529 "frontend/compiler.tab.cpp"
    break;
...
#line 1537 "frontend/compiler.tab.cpp"
    break;
...
#line 1545 "frontend/compiler.tab.cpp"
    break;
...
#line 1553 "frontend/compiler.tab.cpp"
    break;
...
#line 1560 "frontend/compiler.tab.cpp"
    break;
...
#line 1568 "frontend/compiler.tab.cpp"
    break;
...
#line 1576 "frontend/compiler.tab.cpp"
    break;
...
#line 1584 "frontend/compiler.tab.cpp"
    break;
...
#line 1593 "frontend/compiler.tab.cpp"
    break;
...
#line 1602 "frontend/compiler.tab.cpp"
    break;
...
#line 1611 "frontend/compiler.tab.cpp"
    break;
...
#line 1623 "frontend/compiler.tab.cpp"
    break;
...
#line 1635 "frontend/compiler.tab.cpp"
    break;


#line 1639 "frontend/compiler.tab.cpp"
